...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: g-HFqyIPdzDj/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg___9USZy)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__z5Uam)}
              role={"img"}
            />
          ),
